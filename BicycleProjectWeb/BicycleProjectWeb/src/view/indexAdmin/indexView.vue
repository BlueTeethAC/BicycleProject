<template>
  ...
  <div>
    ...
    <div class="shop">
      ...
      <div class="product" v-for="(item,index) in commodityInfo.slice(0,8)" :key="item.commodityId">
        ...
        <span style="float: left;margin-top: 0px;margin-left: 10px">{{item.commodityName}}</span>
        <span style="float: right;margin-top: 0px;margin-right: 10px">{{towNumber(item.price)}}元</span>
      </div>
...
import carousel from "@/view/indexAdmin/components/carousel.vue";
